...
class PluginGenerator:
    ...
    def generate(
        ...
        self._render_template(
            'pyproject.toml.j2', project_path / 'pyproject.toml', context
        )
        ...
        self._render_template(
            'test_plugins.py.j2', test_path / 'test_plugins.py', context
        )
        self._render_template(
            'test_deployment.yaml.j2', project_path / 'test_deployment.yaml', context
        )
